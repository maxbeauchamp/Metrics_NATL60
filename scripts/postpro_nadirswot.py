...
Grad_GENN_nadirswot_file        = scratchpath+'/resIA_nadirswot_nadlag_'+NN_lag+"_"+type_obs+'/GB1_GENN_wmissing_wOI/saved_path_000_GENN_wmissing.pickle'
...
#    itrp_Grad_GENN_nadirswot, rec_Grad_GENN_nadirswot = pickle.load(handle)[7:9]
...
colors      = np.array(['k','','red','seagreen','steelblue','mediumorchid','darkorange'])#,'darkblue'])
